  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button 
        ...
        className="relative text-white/85 hover:text-white transition-colors duration-200 outline-none group flex items-center justify-center p-2 rounded-lg hover:bg-white/15"
        title="Notifications"
      >
